                    ...
                    <div className="card">
                      <div className="card-header p-2">
                        <ul className="nav nav-pills">
                          ...
                          <li className="nav-item">
                            <Link to="" className="nav-link" href="#timeline" data-toggle="tab">
                              Timeline
                            </Link>
                          </li>
                          <li className="nav-item">
                            <Link to="" className="nav-link" href="#settings" data-toggle="tab">
                              Settings
                            </Link>
                          </li>
                        </ul>
                            ...
                            <div className="timeline timeline-inverse">
                              ...
                              <div>
                                ...
                                <div className="timeline-item">
                                  ...
                                  <h3 className="timeline-header">
                                    <Link to="#">Support Team</Link> sent you an email
                                  </h3>
                              ...
                              <div>
                                ...
                                <div className="timeline-item">
                                  ...
                                  <h3 className="timeline-header border-0">
                                    <Link to="#">Sarah Young</Link> accepted your friend
                                    request
                                  </h3>
                                </div>
                              </div>
                              ...
                              <div>
                                ...
                                <div className="timeline-item">
                                  ...
                                  <h3 className="timeline-header">
                                    <Link to="#">Jay White</Link> commented on your post
                                  </h3>
                                  <div className="timeline-body">
                              ...
                              <div>
                                ...
                                <div className="timeline-item">
                                  ...
                                  <h3 className="timeline-header">
                                    <Link to="#">Mina Lee</Link> uploaded new photos
                                  </h3>
                                  <div className="timeline-body">
